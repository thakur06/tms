...
export default function TimesheetReviewPage() {
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 animate-in fade-in duration-500 max-w-[1400px] mx-auto">
      {/* Header */}
      <div className="flex flex-col xl:flex-row items-start xl:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6 bg-zinc-900/50 p-4 rounded-2xl border border-white/5">
             ...
             <div className="flex flex-col items-end">
                ...
                <span className={`text-xs font-black uppercase tracking-wider px-3 py-1 rounded-full mt-1 border ${
                    timesheet.status === 'approved' ? 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20' :
