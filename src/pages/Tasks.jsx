...
export default function Tasks() {
  ...
  return (
    // Replace just the stats section with this simpler version:
<div className="max-w-[2000px] mx-auto px-4 sm:px-6 py-1">
  {isLoading ? (
    ...
    <>
      <div className="flex items-center justify-between mb-6">
        ...
        <button 
          ...
          className="px-4 py-2 bg-slate-900 text-white text-sm font-medium rounded-lg hover:bg-black transition-colors"
        >
          + New Task
        </button>
      </div>
