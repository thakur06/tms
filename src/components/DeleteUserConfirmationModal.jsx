        ...
        <>
          ...
          >
            <div className="bg-zinc-900 rounded-3xl p-8 border border-white/10 shadow-2xl relative overflow-hidden">
               ...
               <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/5 rounded-full -mr-16 -mt-16 opacity-50" />
               
              <div className="text-center relative z-10">
                <div className="w-16 h-16 bg-red-500/10 text-red-500 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-red-500/20 shadow-sm rotate-3 group-hover:rotate-0 transition-transform duration-300">
                  <IoTrashOutline size={32} />
                </div>
                
                <h3 className="text-xl font-black text-white mb-3 tracking-tight">Confirm Deletion</h3>
                <p className="text-sm text-gray-400 mb-8 leading-relaxed font-medium">
                  Are you sure you want to delete <span className="text-white font-bold">"{userName}"</span>? This action is permanent and cannot be undone.
                </p>
