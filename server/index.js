...
app.post("/api/time-entries", async (req, res) => {
  try {
    const { taskId, user, project, location, remarks, date, hours = 0, minutes = 0 } = req.body;
    ...
    const result = await pool.query(
      `
      INSERT INTO time_entries (task_id, user_name, project_name, location, remarks, entry_date, hours, minutes)
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
      RETURNING *
      `,
      [taskId, user || null, project || null, location || null, remarks || null, date, hours, minutes]
    );
